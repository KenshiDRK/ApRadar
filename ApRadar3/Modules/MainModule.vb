...
Module MainModule
#Region " CONSTANTS "
    Public Const Alla As String = "https://ffxi.allakhazam.com/search.html?q={0}"
    Public Const wiki As String = "https://ffxiclopedia.fandom.com/wiki/Special:Search?query={0}"
    Public Const ffxiah As String = "https://www.ffxiah.com/search/item?q={0}"
    Public Const ffxiahItemUrl As String = "https://www.ffxiah.com/item/{0}/"
