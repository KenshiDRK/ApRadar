...
#Region " ENUM "
    ...
    Public Enum RegType As UInteger
        REG_NAME = 0
        REG_SZ
        REG_EXPAND_SZ
        REG_BINARY
...
#Region " API "
    ...
    Public Function RegQueryValueEx(keyBase As UIntPtr, valueName As String, reserved As IntPtr, ByRef type As RegType, zero As IntPtr, ByRef dataSize As Integer) As Integer
    End Function
    ...
    ''' <returns></returns>
    <DllImport("advapi32.dll", CharSet:=CharSet.Unicode, EntryPoint:="RegQueryValueEx")> _
    Public Function RegQueryValueEx(keyBase As UIntPtr, valueName As String, reserved As IntPtr, ByRef type As RegType, <Out()> data As Byte(), ByRef dataSize As Integer) As Integer
    End Function
    ...
    ''' <returns></returns>
    <DllImport("advapi32.dll", CharSet:=CharSet.Unicode, EntryPoint:="RegQueryValueEx")> _
    Public Function RegQueryValueEx(keyBase As UIntPtr, valueName As String, reserved As IntPtr, ByRef type As RegType, ByRef data As Integer, ByRef dataSize As Integer) As Integer
    End Function
