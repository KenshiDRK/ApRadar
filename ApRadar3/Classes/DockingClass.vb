Public Class DockingClass
    ...
    Friend Sub UpdateDockDrag(ByVal lUpdateDockDragArgs As UpdateDockDragArgs)
        Try
            Dim DiffY As Long = lUpdateDockDragArgs.Y - mStartDragY
            ...
            Dim DiffX As Long = lUpdateDockDragArgs.X - mStartDragX
            ...
            If UseDocking Then
                HandleDocking(NewX, NewY, ToLeftDistance, ToRightDistance, ToTopDistance, ToBottomDistance)
            End If
            ...
            For i = Childen.Count - 1 To 0 Step -1
                Dim cf As ChildForms = Childen(i)
                If cf.ChildForm.IsDisposed Then
                    Childen.Remove(cf)
                Else
