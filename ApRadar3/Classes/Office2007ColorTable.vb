...
#Region "Static Fixed Colors - Blue Color Scheme"
    Private Shared _contextMenuBack As Color = FromHex("#FAFAFA") 'Color.FromArgb(250, 250, 250)
...
#End Region
    ...
    Private Shared Function FromHex(ByVal hex As String) As Color
        If hex.StartsWith("#") Then
            hex = hex.Substring(1)
        End If
        If hex.Length <> 6 Then Throw New Exception("Not a valid color")
        Return Color.FromArgb( _
            Integer.Parse(hex.Substring(0, 2), Globalization.NumberStyles.HexNumber), _
            Integer.Parse(hex.Substring(2, 2), Globalization.NumberStyles.HexNumber), _
            Integer.Parse(hex.Substring(4, 2), Globalization.NumberStyles.HexNumber))
    End Function
End Class
