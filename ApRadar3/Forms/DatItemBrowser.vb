...
#End If
            ...
            'Serializer.SerializeToXML(Of List(Of Item))(Application.StartupPath & "ItemsDump.xml", _items)
    ...
    Private Sub dgItems_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgItems.CellMouseClick
